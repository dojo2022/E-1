...
public class Review_Insert {
	...
	public Review_Insert(int review_id, String user_name, int genre_id, String review_day, String title,
			String series_name, String thought, int evalution, int good, String address, String puroduct_name,
